...
public class Main {
    private static gr.aueb.cf.schoolapp.controllerview.Menu menu;
...
//    private static SearchForm2 searchForm2;
//    private static SearchUsers searchUsers;
//    private static LoginPage loginPage;
//    private static InsertUsers insertUsers;
...
//	public static Version version;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    menu = new gr.aueb.cf.schoolapp.controllerview.Menu();
