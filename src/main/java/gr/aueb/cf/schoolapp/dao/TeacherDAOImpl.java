...
public class TeacherDAOImpl implements ITeacherDAO {
    ...
    public Teacher getById(Integer id) throws TeacherDAOException {
        ...
        PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            throw new TeacherDAOException("SQL Get Id Error In Teacher With Id: " + id);
        }
        return teacher;
    }
    ...
    public List<Teacher> getByLastname(String lastname) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                Teacher teacher = new Teacher(rs.getInt("ID"), rs.getString("FIRSTNAME"),
                        rs.getString("LASTNAME"));
                teachers.add(teacher);
            }
        } catch (SQLException e) {
            e.printStackTrace();
            throw new TeacherDAOException("SQL Get lastname Error In Teacher With lastname: " + lastname);
        }
        return teachers;
    }
}
